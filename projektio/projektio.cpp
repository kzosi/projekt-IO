...
public:
    ...
    void BMI() {
        ...
        cout << "18.5 - 24.99 - wartoœæ prawid³owa" << endl;
        cout << "25 - 29.99 - nadwaga" << endl;
        cout << "30 - 34.99 - I stopieñ oty³oœci" << endl;
        cout << "35 - 39.99 - II stopieñ oty³oœci" << endl;
        cout << "powy¿ej 40 - oty³oœæ skrajna" << endl;
...
int main()
{
    ...
    while (loginojb.acces == true) {
        ...
        cout << "3. Profil" << endl;//
        cout << "4. SprawdŸ cele" << endl;//
        cout << "5. SprawdŸ plan" << endl;//
        cout << "6. Kalkulator kalorii" << endl;//
        cout << "7. SprawdŸ BMI" << endl;//
        ...
        case '3':
            ...
            //Interface 3
            cout << "PROFIL" << endl;
            cout << "1. Wyœwietl informacje" << endl;
            ...
            case '1':
                system("CLS");
                userobj.showinfo();
                cout << endl << endl << "|Naciœnij 1 by wyjœæ|" << endl;
                cin >> back;
                if (back == 1) {
                    back = 0;
                    system("CLS");
